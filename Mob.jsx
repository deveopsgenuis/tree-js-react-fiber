...
Command: npx gltfjsx@6.2.7 public/models/mob.glb
*/
...
export function Model(props) {
  const { nodes, materials } = useGLTF('/mob.glb')
  return (
    <group {...props} dispose={null}>
      <group position={[-0.075, -0.71, 0.265]} scale={0.578}>
