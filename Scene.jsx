...
Command: npx gltfjsx@6.2.7 public/models/scene.glb
*/
...
export function Model(props) {
  ...
  return (
    <group {...props} dispose={null}>
      <directionalLight intensity={1} decay={2} position={[5, 33.736, 7.5]} />
      <directionalLight intensity={1} decay={2} position={[5, 10, 7.5]} />
      <directionalLight intensity={1} decay={2} position={[-12.638, 10, 7.5]} />
      <mesh geometry={nodes.Plane.geometry} material={nodes.Plane.material} position={[2.029, 17.945, -0.255]} rotation={[-0.387, -0.346, -0.192]} scale={[9.832, 1.686, 1]} />
